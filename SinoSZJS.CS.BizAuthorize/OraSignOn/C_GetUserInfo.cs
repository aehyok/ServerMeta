    ...
    public class C_GetUserInfo
    {
        ...
        public static SinoUser GetUserInfoByYHID(string _yhid)
        {
            ...
            using (OracleConnection cn = OracleHelper.OpenConnection())
            {
                ...
                OracleCommand _cmd = new OracleCommand(SQL_GetUserInfoByYHID, cn);
        ...
        public static SinoUser GetUserInfoByLoginName(string _userName)
        {
            ...
            using (OracleConnection cn = OracleHelper.OpenConnection())
            {
                ...
                DataTable _yhdt = OracleHelper.FillDataTable(cn, CommandType.Text, SQL_GetUserInfoByLoginName, _param);
        ...
        public static DataTable Get_QVRightsByRoleID(string _jsid, string spaces)
        {
            ...
            using (OracleConnection cn = OracleHelper.OpenConnection())
            {
                ...
                _dt = OracleHelper.FillDataTable(cn, CommandType.Text, _sb.ToString(), _param);
                cn.Close();
                return _dt;
            }
        }
        ...
        public static bool Update_RoleToRightData(DataTable QxData, DataTable QvQxData, string _jsid)
        {
            using (OracleConnection cn = OracleHelper.OpenConnection())
            {
                ...
                List<OracleParameter> _plist = new List<OracleParameter>();  //_cmd = new OracleCommand(_delqv, cn);
                _plist.Add(new OracleParameter(":JSID", decimal.Parse(_jsid)));
                OracleHelper.ExecuteNonQuery(cn, CommandType.Text, _delqv, _plist.ToArray()); //_cmd.ExecuteNonQuery();

                foreach (DataRow _dr in QvQxData.Select("SFY=1"))
                {
                    OracleCommand _cmd2 = new OracleCommand("insert into qx_jscxmxgxb (ID,JSID,NAMESPACE,VIEWID) values (seq_qx2.nextval,:JSID,:NAMESPACE,:VIEWID)", cn);
                    _cmd2.Parameters.Add(":JSID", decimal.Parse(_jsid));
        ...
        public static bool Update_RoleToRightData(string _jsid, string _jsmc, string _jssm, DataTable QxData, DataTable QvQxData)
        {
            using (OracleConnection cn = OracleHelper.OpenConnection())
            {
                ...
                OracleCommand _cmdupdate = new OracleCommand("update qx_jsdyb set JSMC=:JSMC,JSSM=:JSSM where JSID=:JSID", cn);
                ...
                {
                    string _jbstr = _dr.IsNull("QXJB") ? "null" : _dr["QXJB"].ToString();
                    OracleCommand _cmd2 = new OracleCommand("insert into qx_jsqxgxb (ID,JSID,QXID,QXJB) values (seq_qx2.nextval,:JSID,:QXID,:QXJB)", cn);
                    _cmd2.Parameters.Add(":JSID", decimal.Parse(_jsid));
                    _cmd2.Parameters.Add(":QXID", decimal.Parse(_dr["QXID"].ToString()));
                    _cmd2.Parameters.Add(":QXJB", _jbstr);
                    _cmd2.ExecuteNonQuery();
        ...
        public static bool Insert_NewRole(string _jsmc, string _ssdwid)
        {
            ...
            using (OracleConnection cn = OracleHelper.OpenConnection())
            {
                ...
                OracleHelper.ExecuteNonQuery(cn, CommandType.Text, _insert.ToString(), _param);
        ...
        public static SinoUser GetNoRegisterUserByUserID(decimal _yhid)
        {
            ...
            using (OracleConnection cn = OracleHelper.OpenConnection())
            {
                OracleCommand _cmd = new OracleCommand(SQL_GetNoRegisterUserByUserID, cn);
        ...
        public static SinoUser GetNoRegisterUserByUserName(string _name)
        {
            ...
            using (OracleConnection cn = OracleHelper.OpenConnection())
            {
                ...
                OracleCommand _cmd = new OracleCommand(SQL_GetNoRegisterUserByUserName, cn);
