    ...
    public class OraMetaDataFactroy : IMetaDataFactroy
    {
        ...
        public MD_QueryModel GetQueryModelByName(string modelName)
        {
            ...
            else
            {
                ...
                while (dr.Read())
                {
                    modelInfo = new MD_QueryModel(dr.GetSqlDecimal(0).ToString(), dr.GetString(1), dr.GetString(2),
                                    dr.IsDBNull(3) ? "" : dr.GetString(3), dr.IsDBNull(4) ? "" : dr.GetString(4), dr.IsDBNull(5) ? "" : dr.GetString(5),
                                    dr.IsDBNull(6) ? false : dr.GetSqlDecimal(6).Value > 0, dr.IsDBNull(7) ? false : dr.GetSqlDecimal(7).Value > 0,
                                    dr.IsDBNull(8) ? false : dr.GetSqlDecimal(8).Value > 0, dr.IsDBNull(9) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(9).Value),
        ...
        public MD_QueryModel GetQueryModelByName(string modelName, string nameSpace)
        {
            ...
            SqlDataReader dr = SqlHelper.ExecuteReader(SqlHelper.ConnectionStringProfile, CommandType.Text, SQL_GetQueryModelByName2, _param);
        ...
        public MD_RefTable GetRefTable(string refTableName)
        {
            ...
            while (dr.Read())
            {
                _ret = new MD_RefTable(dr.GetSqlDecimal(0).ToString(), dr.GetString(1), dr.GetString(2),
                                   dr.IsDBNull(3) ? "" : dr.GetString(3), dr.IsDBNull(4) ? "" : dr.GetString(4), dr.IsDBNull(5) ? "" : dr.GetString(5),
                                   dr.IsDBNull(6) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(6).Value),
                                   dr.IsDBNull(7) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(7).Value),
        ...
        public IList<MD_Namespace> GetNameSpaceAtNode(string _nodeDWDM)
        {
            ...
            SqlParameter[] _param = {
                                new SqlParameter(":DWDM", SqlDbType.VarChar, 12),
                        };
            ...
            while (dr.Read())
            {
                ...
                nodeInfo.DisplayOrder = dr.IsDBNull(5) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(5).Value);
        ...
        public bool SaveNewNameSapce(MD_Namespace _ns)
        {
            ...
            SqlParameter[] _param = {
                                ...
                                new SqlParameter(":MENUPOSITION", SqlDbType.VarChar, 50),
                                ...
                                new SqlParameter(":DWDM", SqlDbType.VarChar, 12),
                                new SqlParameter(":CONCEPTS", SqlDbType.VarChar, 1000)
        ...
        public bool SaveNodes(MD_Nodes _nodes)
        {
            ...
            SqlParameter[] _param = {
                                new SqlParameter(":NODENAME", SqlDbType.VarChar, 100),
                                new SqlParameter(":DISPLAYTITLE", SqlDbType.VarChar, 200),
                                new SqlParameter(":DESCRIPT", SqlDbType.VarChar, 2000),
                                new SqlParameter(":DWDM", SqlDbType.VarChar, 100),
        ...
        public bool SaveNameSapce(MD_Namespace _ns)
        {
            ...
            SqlParameter[] _param = {                                
                                new SqlParameter(":DESCRIPTION", SqlDbType.VarChar, 100),
                                new SqlParameter(":MENUPOSTION", SqlDbType.VarChar, 50),
                                new SqlParameter(":DISPLAYTITLE", SqlDbType.VarChar, 50),
                                new SqlParameter(":OWNER", SqlDbType.VarChar, 50),
                                new SqlParameter(":DISPLAYORDER", SqlDbType.Decimal),
                                new SqlParameter(":DWDM", SqlDbType.VarChar, 12),
        ...
        public bool DelNamespace(MD_Namespace _ns)
        {
            using (SqlConnection cn = SqlHelper.OpenConnection())
            {
                ...
                {
                    SqlParameter[] _param = {
                                                         new SqlParameter(":NAMESPACE", SqlDbType.VarChar, 100)   
                                                };
                    _param[0].Value = _ns.NameSpace;
        ...
        public IList<DB_TableMeta> GetDBTableList()
        {
            ...
            SqlParameter[] _param = {                                
                                new SqlParameter(":CURRENTOWNER",_cowner)};

            SqlDataReader dr = SqlHelper.ExecuteReader(SqlHelper.ConnectionStringProfile, CommandType.Text, SQL_GetDBTableList, _param);
        ...
        public bool SaveNewTable(DB_TableMeta _tm, MD_Namespace _ns)
        {
            ...
            SqlParameter[] _param = {
                                ...
                                new SqlParameter(":TABLETYPE", SqlDbType.VarChar, 50),
                                new SqlParameter(":DESCRIPTION", SqlDbType.VarChar, 100),
        ...
        public IList<MD_Table> GetTablesAtNamespace(string NsName)
        {
            ...
            while (dr.Read())
            {
                MD_Table nodeInfo = new MD_Table(dr.GetSqlDecimal(0).ToString(), dr.GetString(1), dr.GetString(2), dr.GetString(3),
        ...
        public MD_Table GetTableByTableID(string _tid)
        {
            ...
            while (dr.Read())
            {
                _ret = new MD_Table(dr.GetSqlDecimal(0).ToString(), dr.GetString(1), dr.GetString(2), dr.GetString(3),
                                dr.IsDBNull(4) ? "" : dr.GetString(4), dr.IsDBNull(5) ? "" : dr.GetString(5), dr.IsDBNull(6) ? "" : dr.GetString(6),
                                dr.IsDBNull(7) ? "" : dr.GetString(7), dr.IsDBNull(8) ? "" : dr.GetString(8), dr.IsDBNull(9) ? "" : dr.GetString(9),
                                dr.IsDBNull(10) ? "" : dr.GetString(10));
        ...
        public IList<MD_QueryModel> GetQueryModelAtNamespace(string NsName)
        {
            ...
            while (dr.Read())
            {
                MD_QueryModel nodeInfo = new MD_QueryModel(dr.GetSqlDecimal(0).ToString(), dr.GetString(1), dr.GetString(2),
                                dr.IsDBNull(3) ? "" : dr.GetString(3), dr.IsDBNull(4) ? "" : dr.GetString(4), dr.IsDBNull(5) ? "" : dr.GetString(5),
                                dr.IsDBNull(6) ? false : dr.GetSqlDecimal(6).Value > 0, dr.IsDBNull(7) ? false : dr.GetSqlDecimal(7).Value > 0,
                                dr.IsDBNull(8) ? false : dr.GetSqlDecimal(8).Value > 0, dr.IsDBNull(9) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(9).Value),
                                dr.IsDBNull(10) ? "ORA_JSIS" : dr.GetString(10));
        ...
        public IList<MD_RefTable> GetRefTableAtNamespace(string _ns)
        {
            ...
            while (dr.Read())
            {
                MD_RefTable nodeInfo = new MD_RefTable(dr.GetSqlDecimal(0).ToString(), dr.GetString(1), dr.GetString(2),
                                dr.IsDBNull(3) ? "" : dr.GetString(3), dr.IsDBNull(4) ? "" : dr.GetString(4), dr.IsDBNull(5) ? "" : dr.GetString(5),
                                dr.IsDBNull(6) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(6).Value),
                                dr.IsDBNull(7) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(7).Value),
                                dr.IsDBNull(8) ? false : (dr.GetDecimal(8) > 0));
        ...
        public MD_TableColumn GetColumnOfTable(string _tcid)
        {
            ...
            while (dr.Read())
            {
                nodeInfo = new MD_TableColumn(
                               dr.GetSqlDecimal(0).ToString(), dr.GetSqlDecimal(1).ToString(), dr.GetString(2),
                               dr.IsDBNull(3) ? true : ((dr.GetString(3) == "Y") ? true : false),
                               dr.GetString(4),
                               dr.IsDBNull(5) ? 1 : Convert.ToInt32(dr.GetSqlDecimal(5).Value),
                               dr.IsDBNull(6) ? 1 : Convert.ToInt32(dr.GetSqlDecimal(6).Value),
                               dr.IsDBNull(7) ? 1 : Convert.ToInt32(dr.GetSqlDecimal(7).Value),
                               dr.IsDBNull(8) ? "" : dr.GetString(8),
                               dr.IsDBNull(9) ? "" : dr.GetString(9),
                               dr.IsDBNull(10) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(10).Value),
                               dr.IsDBNull(11) ? "" : dr.GetString(11),
                               dr.IsDBNull(12) ? "" : dr.GetString(12),
                               dr.IsDBNull(13) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(13).Value),
                               dr.IsDBNull(14) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(14).Value),
                               dr.IsDBNull(15) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(15).Value),
                               dr.IsDBNull(16) ? false : dr.GetSqlDecimal(16).Value > 0,
                               dr.IsDBNull(17) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(17).Value),
        ...
        public MD_ViewTable GetMainTableOfQueryModel(string QueryModelID)
        {
            ...
            SqlParameter[] _param = {
                                new SqlParameter(":VID", SqlDbType.Decimal),
                        };
            ...
            while (dr.Read())
            {
                _vt = new MD_ViewTable(dr.GetSqlDecimal(0).ToString(),
                                dr.GetSqlDecimal(1).ToString(),
                                dr.GetSqlDecimal(2).ToString(),
                                ...
                                dr.IsDBNull(7) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(7).Value),
                                dr.IsDBNull(8) ? "" : dr.GetString(8),
                                dr.IsDBNull(9) ? "" : dr.GetSqlDecimal(9).ToString(),
                                dr.IsDBNull(10) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(10).Value),
                                dr.IsDBNull(11) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(11).Value),
                                dr.IsDBNull(12) ? "" : dr.GetString(12)
            ...
            using (SqlConnection cn = SqlHelper.OpenConnection())
            {
                ...
                while (_dr.Read())
                {
                    nodeInfo = new MD_ViewTableColumn(
                       _dr.IsDBNull(0) ? "" : _dr.GetSqlDecimal(0).ToString(),
                       _dr.IsDBNull(1) ? "" : _dr.GetSqlDecimal(1).ToString(),
                       _dr.IsDBNull(2) ? "" : _dr.GetSqlDecimal(2).ToString(),
                       _dr.IsDBNull(3) ? false : _dr.GetSqlDecimal(3).Value > 0,
                       _dr.IsDBNull(4) ? false : _dr.GetSqlDecimal(4).Value > 0,
                       _dr.IsDBNull(5) ? false : _dr.GetSqlDecimal(5).Value > 0,
                       _dr.IsDBNull(6) ? false : _dr.GetSqlDecimal(6).Value > 0,
                       _dr.IsDBNull(7) ? false : _dr.GetSqlDecimal(7).Value > 0,
                       _dr.IsDBNull(8) ? "" : _dr.GetString(8),
                       _dr.IsDBNull(9) ? 0 : Convert.ToInt32(_dr.GetSqlDecimal(9).Value),
                       _dr.IsDBNull(10) ? 0 : Convert.ToInt32(_dr.GetSqlDecimal(10).Value)
                       );
            ...
            /*
                        ...
                        while (dr.Read())
                        {
                                ...
                                MD_ViewTableColumn nodeInfo = new MD_ViewTableColumn(
                                                ...
                                                dr.IsDBNull(19) ? "" : dr.GetString(19),
                                                dr.IsDBNull(20) ? "" : dr.GetString(20),
                                                dr.GetSqlDecimal(21).ToString(),
                                                dr.IsDBNull(22) ? false : dr.GetSqlDecimal(22).Value > 0,
                                                dr.IsDBNull(23) ? false : dr.GetSqlDecimal(23).Value > 0,
                                                dr.IsDBNull(24) ? false : dr.GetSqlDecimal(24).Value > 0,
                                                dr.IsDBNull(25) ? false : dr.GetSqlDecimal(25).Value > 0,
                                                dr.IsDBNull(26) ? false : dr.GetSqlDecimal(26).Value > 0,
                                                dr.IsDBNull(27) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(27).Value)
                                                );
                                nodeItems.Add(nodeInfo);
        ...
        public IList<DB_ColumnMeta> GetDBColumnsOfTable(string _tableName)
        {
            ...
            while (dr.Read())
            {
                ...
                nodeInfo.DataLength = dr.IsDBNull(4) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(4).Value);
                nodeInfo.DataPrecision = dr.IsDBNull(5) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(5).Value);
        ...
        {
            object _ret = SqlHelper.ExecuteScalar(SqlHelper.ConnectionStringProfile, CommandType.Text, SQL_GetNewID);
        ...
        public bool SaveTableDefine(MD_Table _table)
        {
            ...
            SqlParameter[] _param = {
                                ...
                                new SqlParameter(":DISPLAYNAME", SqlDbType.VarChar, 100),
                                new SqlParameter(":DWDM", SqlDbType.VarChar, 12),
                                new SqlParameter(":MAINKEY",SqlDbType.VarChar,50),
                                new SqlParameter(":SECRETFUN",SqlDbType.VarChar,50),
                                new SqlParameter(":EXTSECRET",SqlDbType.VarChar,1000),
                                new SqlParameter(":RESTYPE",SqlDbType.VarChar,100),
                                new SqlParameter(":TID",SqlDbType.Decimal)
                        };
            ...
            using (SqlConnection cn = SqlHelper.OpenConnection())
            {
                ...
                SqlParameter Param1 = cmd.Parameters.Add(new SqlParameter(":1", SqlDbType.Decimal));
                SqlParameter Param2 = cmd.Parameters.Add(new SqlParameter(":2", SqlDbType.Decimal));
                SqlParameter Param3 = cmd.Parameters.Add(new SqlParameter(":3", SqlDbType.VarChar, 10));
                ...
                _TCIDActions = Param3.Value as SqlString[];
        ...
        private void UpdateColumnDefine(MD_Table _table, MD_TableColumn _tc)
        {
            ...
            SqlParameter[] _param3 = {                                        
                                        ...
                                        new SqlParameter(":ISNULLABLE", SqlDbType.VarChar, 100),
                                        new SqlParameter(":TYPE", SqlDbType.VarChar, 20),
                                        new SqlParameter(":PRECISION", SqlDbType.Decimal),
                                        new SqlParameter(":SCALE",SqlDbType.Decimal),
                                        new SqlParameter(":LENGTH",SqlDbType.Decimal),
                                        new SqlParameter(":REFDMB",SqlDbType.VarChar,50),
                                        new SqlParameter(":DMBLEVELFORMAT",SqlDbType.VarChar,20),
                                        new SqlParameter(":SECRETLEVEL", SqlDbType.Decimal),
                                        new SqlParameter(":DISPLAYTITLE", SqlDbType.VarChar, 50),
                                        new SqlParameter(":DISPLAYFORMAT", SqlDbType.VarChar, 50),
                                        new SqlParameter(":DISPLAYLENGTH", SqlDbType.Decimal),
                                        new SqlParameter(":DISPLAYHEIGHT", SqlDbType.Decimal),
                                        new SqlParameter(":DISPLAYORDER", SqlDbType.Decimal),
                                        new SqlParameter(":CANDISPLAY",SqlDbType.Decimal),
                                        new SqlParameter(":COLWIDTH",SqlDbType.Decimal),
                                        new SqlParameter(":DWDM",SqlDbType.VarChar,20),
                                        new SqlParameter(":CTAG",SqlDbType.VarChar,500),
                                        new SqlParameter(":REFWORDTB",SqlDbType.VarChar,50),
                                        new SqlParameter(":TCID", SqlDbType.Decimal)
                                };
        ...
        public bool SaveNewQueryModel(MD_QueryModel _queryModel)
        {
            ...
            SqlParameter[] _param = {                                
                                ...
                                new SqlParameter(":DISPLAYORDER",SqlDbType.Decimal),
                                new SqlParameter(":NAMESPACE",SqlDbType.VarChar,50),
                                 new SqlParameter(":EXTMETA",SqlDbType.VarChar,4000)
                        };
        ...
        public bool SaveQueryModel(MD_QueryModel _queryModel)
        {
            ...
            SqlParameter[] _param = {                                
                                ...
                                new SqlParameter(":IS_SJSH",SqlDbType.Decimal),
                                new SqlParameter(":DISPLAYORDER",SqlDbType.Decimal),
                                new SqlParameter(":ICSTYPE", SqlDbType.VarChar, 20),
                                new SqlParameter(":EXTMETA", SqlDbType.VarChar, 4000),
                                new SqlParameter(":VIEWID",SqlDbType.Decimal)
                        };
                    ...
                    foreach (MD_ViewTable _vtable in _qv.ChildTables)
                    {
                        if (_vtable != null)
                        {
                            ...
                            SqlParameter[] _param5 = {            
                                                                                ...
                                                                                new SqlParameter(":VIEWID",SqlDbType.Decimal),
                                                                                new SqlParameter(":TID",SqlDbType.Decimal),
                                                                                 new SqlParameter(":TABLETYPE",SqlDbType.VarChar,20),                                        
                                                                                new SqlParameter(":TABLERELATION",SqlDbType.VarChar,300),
                                                                                new SqlParameter(":CANCONDITION",SqlDbType.VarChar,10),
                                                                                new SqlParameter(":DISPLAYNAME",SqlDbType.VarChar,100),
                                                                                new SqlParameter(":DISPLAYORDER",SqlDbType.Decimal),
                                                                                new SqlParameter(":DWDM",SqlDbType.VarChar,12),
                        ...
                        foreach (MD_View2ViewGroup _group in _qv.View2ViewGroup)
                        {
                            ...
                            foreach (MD_View2View _v2v in _group.View2Views)
                            {
                                SqlParameter[] _pv2v = {
                                                                        new SqlParameter(":ID", SqlDbType.VarChar, 50),
                                                                        new SqlParameter(":VIEWID", SqlDbType.Decimal),
                                                                        new SqlParameter(":TARGETVIEWNAME", SqlDbType.VarChar,300),
                                                                        new SqlParameter(":RELATIONSTR", SqlDbType.VarChar,4000),
                                                                        new SqlParameter(":DISPLAYORDER", SqlDbType.Decimal),
                                                                        new SqlParameter(":DISPLAYTITLE", SqlDbType.VarChar, 200),
        ...
        public bool SaveViewMainTable(MD_ViewTable _viewtable)
        {
            SqlParameter[] _param = {            
                                new SqlParameter(":DISPLAYNAME",SqlDbType.VarChar,100),
                                new SqlParameter(":INTEGRATEDAPP",SqlDbType.VarChar,1000),
                                new SqlParameter(":VTID",SqlDbType.Decimal)
                        };
        ...
        public IList<MD_ViewTable> GetChildTableOfQueryModel(string QueryModelID)
        {
            ...
            while (dr.Read())
            {
                MD_ViewTable _vt = new MD_ViewTable(dr.GetSqlDecimal(0).ToString(),
                                dr.GetSqlDecimal(1).ToString(),
                                dr.GetSqlDecimal(2).ToString(),
                                dr.IsDBNull(3) ? "M" : dr.GetString(3),
                                dr.IsDBNull(4) ? "" : dr.GetString(4),
        ...
        public bool SaveViewChildTable(MD_ViewTable _viewtable)
        {
            SqlParameter[] _param = {            
                                ...
                                new SqlParameter(":CANCONDITION",SqlDbType.VarChar,10),
                                new SqlParameter(":DISPLAYORDER",SqlDbType.Decimal),
                                new SqlParameter(":DISPLAYTYPE",SqlDbType.Decimal),
                                new SqlParameter(":INTEGRATEDAPP",SqlDbType.VarChar,1000),
                                new SqlParameter(":VTID",SqlDbType.Decimal)
                        };
            _param[0].Value = _viewtable.DisplayTitle;
        ...
        public bool SaveNewRefTable(DB_TableMeta _tm, MD_Namespace _namespace)
        {
            ...
            SqlParameter[] _param = {            
                                new SqlParameter(":NAMESPACE",SqlDbType.VarChar,50),
                                new SqlParameter(":REFTABLENAME",SqlDbType.VarChar,50),
                                new SqlParameter(":DESCRIPTION",SqlDbType.VarChar,100),
                                new SqlParameter(":DWDM",SqlDbType.VarChar,12)                                                         
                        };
        ...
        public bool SaveRefTable(MD_RefTable _refTable, DataTable _refData)
        {
            ...
            SqlParameter[] _param = {            
                                new SqlParameter(":LEVELFORMAT",SqlDbType.VarChar,20),
                                new SqlParameter(":DES",SqlDbType.VarChar,100),
                                new SqlParameter(":DOWNLOAD",SqlDbType.Decimal),
                                new SqlParameter(":REFMODE",SqlDbType.Decimal),
                                 new SqlParameter(":HIDECODE",SqlDbType.Decimal), 
                                new SqlParameter(":RTID",SqlDbType.Decimal)                               
                        };
        ...
        public bool ImportRefTableDefine(MD_RefTable _rt)
        {
            ...
            SqlParameter[] _param = {          
                                ...
                                new SqlParameter(":NAMESPACE",SqlDbType.VarChar,50),
                                new SqlParameter(":REFTABLENAME",SqlDbType.VarChar,50),
                                new SqlParameter(":REFTABLELEVELFORMAT",SqlDbType.VarChar,20),
                                new SqlParameter(":DESCRIPTION",SqlDbType.VarChar,100),
                                new SqlParameter(":DOWNLOADMODE",SqlDbType.Decimal),
                                new SqlParameter(":REFTABLEMODE",SqlDbType.Decimal),
                                new SqlParameter(":DWDM",SqlDbType.VarChar,12)    ,
                                 new SqlParameter(":HIDECODE",SqlDbType.Decimal)
                        };
        ...
        public IList<MD_Menu> GetMenuDefineOfNode(string _nodeCode)
        {
            ...
            SqlParameter[] _param = {            
                                new SqlParameter(":SYSTEMID",SqlDbType.VarChar,12)
                        };
            ...
            while (dr.Read())
            {
                ...
                _vt.MenuID = dr.GetSqlDecimal(0).ToString();
                _vt.MenuName = dr.GetString(1);
                _vt.MenuType = dr.IsDBNull(2) ? "" : dr.GetString(2);
                _vt.MenuParameter = dr.IsDBNull(3) ? "" : dr.GetString(3);
                _vt.DisplayOrder = dr.IsDBNull(4) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(4).Value);
                _vt.FatherMenuID = dr.GetSqlDecimal(5).ToString();
        ...
        public bool SaveMenuDefine(MD_Menu _menu)
        {
            ...
            SqlParameter[] _param = {            
                                ...
                                new SqlParameter(":MENUCS",SqlDbType.VarChar,1000),
                                new SqlParameter(":DISPLAYORDER",SqlDbType.Decimal),
                                new SqlParameter(":MENUTOOLTIP",SqlDbType.VarChar,1000),
                                new SqlParameter(":ICONNAME",SqlDbType.VarChar),
                                new SqlParameter(":SHOWTOOLBAR",SqlDbType.VarChar,10),
        ...
        public bool DelSystemMenu(string _menuid)
        {
            ...
            SqlParameter[] _param = { 
                                new SqlParameter(":MID",SqlDbType.Decimal)
                        };
        ...
        public IList<MD_GuideLineGroup> GetGuideLineGroup(string _nodeCode, string _guideLineGroupType)
        {
            ...
            SqlParameter[] _param = {
                                new SqlParameter(":DWDM",SqlDbType.VarChar,12),
                                new SqlParameter(":LX",SqlDbType.Decimal)
                        };
            _param[0].Value = _nodeCode;
            ...
            while (dr.Read())
            {
                MD_GuideLineGroup _vt = new MD_GuideLineGroup(
                                ...
                                dr.IsDBNull(4) ? "" : dr.GetString(4),
                                dr.IsDBNull(5) ? "" : dr.GetString(5),
                                dr.IsDBNull(2) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(2).Value),
                                dr.IsDBNull(3) ? 0 : Convert.ToInt32(dr.GetSqlDecimal(3).Value)
                                );
                _ret.Add(_vt);
            }
            dr.Close();
        ...
        public bool SaveGuideLineGroupDefine(MD_GuideLineGroup _GuideLineGroup)
        {
            ...
            SqlParameter[] _param = {            
                                new SqlParameter(":ZBZTSM",SqlDbType.VarChar,200),
                                new SqlParameter(":LX",SqlDbType.Decimal),
                                new SqlParameter(":QXLX",SqlDbType.Decimal),
                                new SqlParameter(":NAMESPACE",SqlDbType.VarChar,50),
                                new SqlParameter(":ZBZTMC",SqlDbType.VarChar,200)                                                           
                        };
        ...
        public IList<MD_GuideLine> GetGuideLineOfGroup(string _groupName)
        {
            ...
            SqlParameter[] _param = {
                                new SqlParameter(":ZBZT",SqlDbType.VarChar,200)
        ...
        public bool DelGuideLineGroup(string _guideLineGroupName)
        {
            ...
            SqlParameter[] _param = {
                                 new SqlParameter(":ZBZTMC", SqlDbType.VarChar, 100)   
                        };
        ...
        public bool SaveNewGuideLineGroupDefine(MD_GuideLineGroup _guideLineGroup)
        {
            ...
            SqlParameter[] _param = {
                                 ...
                                 new SqlParameter(":QXLX", SqlDbType.Decimal),
                                 new SqlParameter(":NAMESPACE", SqlDbType.VarChar, 50),
                                 new SqlParameter(":SSDW", SqlDbType.VarChar, 12)
        ...
        public bool SaveNewGuideLine(string _guideLineName, decimal _fid, string _guideLineGroupName)
        {
            ...
            SqlParameter[] _param = {
                                 new SqlParameter(":ZBMC", SqlDbType.VarChar, 200),
                                 new SqlParameter(":ZBZT", SqlDbType.VarChar, 200),
                                 new SqlParameter(":FID", SqlDbType.Decimal)                                
        ...
        public bool SaveGuideLine(MD_GuideLine _guideLine)
        {
            ...
            SqlParameter[] _param = {
                                new SqlParameter(":ZBMC", SqlDbType.VarChar,200),
                                new SqlParameter(":ZBSF", SqlDbType.VarChar,4000),
                                new SqlParameter(":ZBMETA", SqlDbType.VarChar,4000),
                                new SqlParameter(":XSXH", SqlDbType.Decimal),
                                new SqlParameter(":JSMXMETA",SqlDbType.VarChar,4000),
                                new SqlParameter(":ZBSM",SqlDbType.VarChar,4000),
                                new SqlParameter(":ID", SqlDbType.Decimal)
                        };
        ...
        private void SplitMetaString(string fullString, ref string _metaStr1, ref string _metaStr2)
        {
            ...
            using (SqlConnection cn = SqlHelper.OpenConnection())
            {
                try
                {
                    ...
                    //_cmd.Parameters.Add(new SqlParameter("str1", SqlDbType.VarChar, 4000, "", ParameterDirection.Output));
                    //_cmd.Parameters.Add(new SqlParameter("str2", SqlDbType.VarChar, 4000, "", ParameterDirection.Output));
                    _cmd.ExecuteScalar();
        ...
        public bool SaveConceptGroup(MD_ConceptGroup _ConceptGroup)
        {
            ...
            SqlParameter[] _param = {
                                new SqlParameter(":DESCRIPT", SqlDbType.VarChar),
                                new SqlParameter(":DISPLAYORDER", SqlDbType.Decimal),
        ...
        public bool IsExistConceptTag(string _TagName)
        {
            ...
            SqlParameter[] _param = {            
                                new SqlParameter(":CTAG",SqlDbType.VarChar)                                
                        };
        ...
        public string AddTableRelationView(string _tableID, string _modelName)
        {
            ...
            SqlParameter[] _isParam = {                            
                                new SqlParameter(":TID", SqlDbType.Decimal),
                                new SqlParameter(":VIEWNAME",SqlDbType.VarChar,1000)
                        };
        ...
        public bool SaveViewTable_UserDefine(string _viewTableID, string _displayString, MDType_DisplayType _displayType, List<MD_ViewTableColumn> TableColumnDefine)
        {
            ...
            foreach (MD_ViewTableColumn _tc in TableColumnDefine)
            {
                SqlParameter[] _param4 = {
                                        ...
                                        new SqlParameter(":DISPLAYHEIGHT", SqlDbType.Decimal),
                                        new SqlParameter(":DISPLAYORDER", SqlDbType.Decimal),  
                                        new SqlParameter(":DISPLAYWIDTH",SqlDbType.Decimal),
                                        new SqlParameter(":TCID",SqlDbType.Decimal)
                                };
