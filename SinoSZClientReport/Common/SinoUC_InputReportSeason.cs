...
{
        public partial class SinoUC_InputReportSeason : SinoUC_InputReportDateBase
        {
                public SinoUC_InputReportSeason()
                {
                        InitializeComponent();
                        InitControl();
                }

                public SinoUC_InputReportSeason(DateTime _date)
                {
                        InitializeComponent();
                        this.CB_Year.EditValue = _date.Year;
                        this.CB_Season.SelectedIndex = (_date.Month - 1) / 3;
                        InitControl();
                }
