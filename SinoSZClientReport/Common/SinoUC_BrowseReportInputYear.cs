...
{
        public partial class SinoUC_BrowseReportInputYear : SinoUC_BrowseReportInputBase
        {
                private string RootDWID = "";
                private List<MD_ReportName> ReportItems = new List<MD_ReportName>();
                public SinoUC_BrowseReportInputYear()
                {
                        InitializeComponent();
                }

                public SinoUC_BrowseReportInputYear(List<MD_ReportName> _reportItems, string _rootDWID)
                {
                        InitializeComponent();
