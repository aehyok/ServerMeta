...
{
        public partial class SinoUC_BrowseReportInputHalfYear : SinoUC_BrowseReportInputBase
        {
                private string RootDWID = "";
                private List<MD_ReportName> ReportItems = new List<MD_ReportName>();
                public SinoUC_BrowseReportInputHalfYear()
                {
                        InitializeComponent();
                }

                public SinoUC_BrowseReportInputHalfYear(List<MD_ReportName> _reportItems, string _rootDWID)
                {
                        InitializeComponent();
                ...
                public override DateTime StartDate
                {
                        get
                        {
                                ...
                                {
                                        int _year = int.Parse(this.CB_Year.EditValue.ToString());
                                        int _month = this.cb_Half.SelectedIndex * 6 + 1;
                ...
                public override DateTime EndDate
                {
                        get
                        {
                                ...
                                {
                                        int _year = int.Parse(this.CB_Year.EditValue.ToString());
                                        int _month = this.cb_Half.SelectedIndex * 6 + 6;
                                        DateTime _ret = new DateTime(_year, _month, 1);
                ...
                public override void SetDate(DateTime _startDate, DateTime _endDate)
                {
                        ...
                        this.cb_Half.SelectedIndex = (_startDate.Month - 1) / 6;
                }
